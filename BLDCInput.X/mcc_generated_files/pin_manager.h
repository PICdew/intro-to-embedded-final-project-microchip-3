...
/**
  ...
  @Example
    ...
    // Read RB7
    postValue = Speed_GetValue();
    </code>

*/
#define Speed_GetValue()         _RB7
/**
  @Summary
  ...
  @Example
    ...
    Speed_SetDigitalInput();
    </code>

*/
#define Speed_SetDigitalInput()  _TRISB7 = 1
/**
  @Summary
  ...
  @Example
    ...
    Speed_SetDigitalOutput();
    </code>

*/
#define Speed_SetDigitalOutput() _TRISB7 = 0
